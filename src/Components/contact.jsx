...
const Contact = () => {
    ...
    <div className={`min-h-screen relative w-full flex flex-col justify-text-white items-center ${darkMode ? 'bg-gradient-to-b from-[#0a192f] to-black' : 'bg-gradient-to-b from-[#86a2ee] to-[#75b7f5]'}`} id="contact">
        <div className='flex flex-col min-h-[90vh] justify-center items-center'>
            <div className= "text-yellow-300 text-4xl font-signi mt-12 px-6 text-center font-bold mb-4">
                Let&apos;s Create Something Amazing Together! 🚀
            </div>
            <div className={` ${darkMode? 'text-white' :'text-black'} text-lg font-signi max-w-2xl font-light text-center px-5`}>
            ...
            <div className="mt-8 flex items-center">
                ...
                <span className={`${darkMode? 'text-white' :'text-black'} font-rubi ml-2`}>raghulkannan005@gmail.com</span>
            ...
            <footer className={` ${darkMode?'bg-black/60':'bg-white/10'} w-full h-[10%] flex flex-col items-center`}>
                ...
                <a href="https://github.com/Raghulkannan005" target="_blank" rel="noopener noreferrer" className="flex items-center hover:text-gray-400 m-4">
                    ...
                    <a href="https://twitter.com/raghulkannan_" target="_blank" rel="noopener noreferrer" className="flex items-center hover:text-gray-400 m-4 ">
                        <svg height="32" viewBox="0 0 24 24" width="32" fill="currentColor">
                            <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                        </svg>
                        <span className="ml-2">Twitter</span>
                    </a>
                    <a href="https://www.linkedin.com/in/raghul-kannan-0a4968242" target="_blank" rel="noopener noreferrer" className="flex items-center hover:text-gray-400 m-4">
                        <svg height="32" viewBox="0 0 24 24" width="32" fill="currentColor">
